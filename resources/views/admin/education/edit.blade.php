                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control @error('name_university') is-invalid @enderror"
                                    ...
                                    value="{{ old('name_university', $education->name_university) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control @error('major') is-invalid @enderror"
                                    name="major" value="{{ old('major', $education->major) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="date" class="form-control @error('date_of_entry') is-invalid @enderror"
                                    name="date_of_entry" value="{{ old('date_of_entry', $education->date_of_entry) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="date" class="form-control @error('out_date') is-invalid @enderror"
                                    name="out_date" value="{{ old('out_date', $education->out_date) }}"
                                    placeholder="Input Project Date">
                                <!-- error message untuk title -->
                                @error('out_date')
                                    <span class="error invalid-feedback" style="display: inline;">{{ $message }}</span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <textarea type="textarea" class="form-control @error('title') is-invalid @enderror" name="title"
                                    placeholder="Input Project URL">{{ old('title', $education->title) }}</textarea>
                                <!-- error message untuk title -->
                                @error('title')
