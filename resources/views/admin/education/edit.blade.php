                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control @error('name_university') is-invalid @enderror"
                                        name="name_university" value="{{ old('name_university', $education->name_university) }}" placeholder="Input Name App">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control @error('major') is-invalid @enderror"
                                        name="major" value="{{ old('major', $education->major) }}" placeholder="Input Category">
                                    @error('major')
                                        <span class="error invalid-feedback" style="display: inline;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        name="title" value="{{ old('title', $education->title) }}"
