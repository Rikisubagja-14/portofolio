...
@section('content')
    <div class="card-header ">
        <h3 class="card-title ">@section('title','Edit Summary')</h3>
    </div>
    <br />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <textarea type="textarea" class="form-control @error('title_sumary') is-invalid @enderror"
                                        name="title_sumary" placeholder="Input title summary">{{ old('title_sumary',$summary->title_sumary) }}</textarea>
                                    @error('title_sumary')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control @error('city') is-invalid @enderror"
                                        name="city" value="{{ old('city',$summary->city) }}" placeholder="Input city ">
                                    @error('city')
                                        <span class="error invalid-feedback" style="display: inline;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        name="phone" value="{{ old('phone',$summary->phone) }}" placeholder="Input phone">
                                    @error('phone')
                                        <span class="error invalid-feedback" style="display: inline;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control @error('email') is-invalid @enderror"
                                        name="email" value="{{ old('email',$summary->email) }}" placeholder="Input email">
                                    @error('email')
                                        <span class="error invalid-feedback" style="display: inline;">{{ $message }}</span>
                                    @enderror
                                </div>
