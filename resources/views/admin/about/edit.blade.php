                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea type="textarea" class="form-control @error('desc_about') is-invalid @enderror" name="desc_about"
                                    placeholder="Input Desc About">{{ old('desc_about', $about->desc_about) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea type="textarea" class="form-control @error('title') is-invalid @enderror" name="title"
                                    placeholder="Input title">{{ old('title', $about->title) }}</textarea>
                                @error('title')
                                    <span class="error invalid-feedback"
                                        style="display: inline;">{{ $message }}</span>
                                @enderror
